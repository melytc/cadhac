...
<div class="publicaciones content">
	<section class="banner img-bg bg-black-alpha" data-bg="img/testbg.png">
		<div class="container">
			...
			<a href="publicaciones/desapariciones-nl-2009-a-2016.pdf" class="btn bg-purple2">Descarga el reporte</a>
		</div>
	</section>
	<div class="container">
				...
				<article class="publication">
					<div class="row">
						...
						<div class="col-md-9">
							...
							<a href="publicaciones/desapariciones-nl-2009-a-2016.pdf" class="btn download-report btn-primary bg-lightgreen">Descargar reporte</a>
						</div>
					</div>
					<hr>
				</article>
				...
				<article class="publication">
					<div class="row">
						...
						<div class="col-md-9">
							...
							<a href="publicaciones/protocolo-uso-fuerza.pdf" class="btn download-report btn-primary bg-lightgreen">Descargar reporte</a>
						</div>
					</div>
					<hr>
				</article>
				...
				<article class="publication">
					<div class="row">
						...
						<div class="col-md-9">
							...
							<a href="publicaciones/desaparicion-personas-nl.pdf" class="btn download-report btn-primary bg-lightgreen">Descargar reporte</a>
						</div>
					</div>
					<hr>
				</article>
